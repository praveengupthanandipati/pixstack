...
export const ListitemSkeleton = () => (
  <div className="list-item list-item--skeleton">
    <div className="list-item__img-wrap">
      <div className="list-item__sk-img" />
    </div>
    <div className="list-item__body">
      <div className="list-item__title-row">
        <div className="list-item__sk-line list-item__sk-line--name" />
        <div className="list-item__sk-circle" />
      </div>
      <div className="list-item__sk-line list-item__sk-line--loc" />
      <hr className="list-item__divider" />
      <div className="list-item__footer">
        <div className="list-item__sk-line list-item__sk-line--reviews" />
        <div className="list-item__sk-line list-item__sk-line--rating" />
      </div>
    </div>
  </div>
)
